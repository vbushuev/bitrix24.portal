(function (e) {
	...
	e.each({
		...
		e.Widget.prototype["_" + t] = function (s, a, n) {
			...
			var o,
			r = a ? a === !0 || "number" == typeof a ? i : a.effect || i : t;
			a = a || {},
			"number" == typeof a && (a = {
					duration : a
				}),
	...
	e.widget("ui.accordion", {
		...
		_eventHandler : function (t) {
			...
			t.preventDefault(),
			n && !i.collapsible || this._trigger("beforeActivate", t, l) === !1 || (i.active = o ? !1 : this.headers.index(a), this.active = n ? e() : a, this._toggle(l), s.removeClass("ui-accordion-header-active ui-state-active"), i.icons && s.children(".ui-accordion-header-icon").removeClass(i.icons.activeHeader).addClass(i.icons.header), n || (a.removeClass("ui-corner-all").addClass("ui-accordion-header-active ui-state-active ui-corner-top"), i.icons && a.children(".ui-accordion-header-icon").removeClass(i.icons.header).addClass(i.icons.activeHeader), a.next().addClass("ui-accordion-content-active")))
		},
		_toggle : function (t) {
			var i = t.newPanel,
		...
		_animate : function (e, t, i) {
			...
			t.length ? e.length ? (s = e.show().outerHeight(), t.animate(this.hideProps, {
					...
					step : function (e, i) {
						i.now = Math.round(e),
						"height" !== i.prop ? r += i.now : "content" !== o.options.heightStyle && (i.now = Math.round(s - t.outerHeight() - r), r = 0)
					}
	...
	e.widget("ui.menu", {
		...
		_keydown : function (t) {
			...
			default:
				...
				s.length || (n = String.fromCharCode(t.keyCode), r = RegExp("^" + i(n), "i"), s = this.activeMenu.find(this.options.items).filter(function () {
							return r.test(e(this).text())
						})),
	...
	e.widget("ui.autocomplete", {
		...
		_create : function () {
			...
			n = "textarea" === a,
			o = "input" === a;
			this.isMultiLine = n ? !0 : o ? !1 : this.element.prop("isContentEditable"),
	...
	e.widget("ui.selectmenu", {
		...
		_setOption : function (e, t) {
			...
			"width" === e && (t || (t = this.element.outerWidth()), this.button.outerWidth(t))
		},
		_appendTo : function () {
			var t = this.options.appendTo;
			return t && (t = t.jquery || t.nodeType ? e(t) : this.document.find(t).eq(0)),
	...
	e.widget("ui.slider", e.ui.mouse, {
		...
		_createHandles : function () {
			...
			for (i = s.values && s.values.length || 1, a.length > i && (a.slice(i).remove(), a = a.slice(0, i)), t = a.length; i > t; t++)
				o.push(n);
			this.handles = a.add(e(o.join("")).appendTo(this.element)),
	...
	e.widget("ui.tabs", {
		...
		_tabKeydown : function (t) {
			...
			if (!this._handlePageNav(t)) {
				...
				t.ctrlKey || (i.attr("aria-selected", "false"), this.tabs.eq(s).attr("aria-selected", "true"), this.activating = this._delay(function () {
		...
		_processTabs : function () {
			...
			this.anchors.each(function (i, s) {
				...
				t._isLocal(s) ? (a = s.hash, o = a.substring(1), n = t.element.find(t._sanitizeSelector(a))) : (o = h.attr("aria-controls") || e({}).uniqueId()[0].id, a = "#" + o, n = t.element.find(a), n.length || (n = t._createPanel(o), n.insertAfter(t.panels[i - 1] || t.tablist)), n.attr("aria-live", "polite")),
		...
		_toggle : function (t, i) {
			...
			function a() {
				...
				o.length && n.options.show ? n._show(o, n.options.show, s) : (o.show(), s())
			}
			var n = this,
			o = i.newPanel,
			r = i.oldPanel;
			...
			r.length && this.options.hide ? this._hide(r, this.options.hide, function () {
				...
				a()
			}) : (i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"), r.hide(), a()),
		...
		load : function (t, i) {
			...
			this._isLocal(n[0]) || (this.xhr = e.ajax(this._ajaxSettings(n, i, r)), this.xhr && "canceled" !== this.xhr.statusText && (a.addClass("ui-tabs-loading"), o.attr("aria-busy", "true"), this.xhr.success(function (e) {
						setTimeout(function () {
							o.html(e),
							s._trigger("load", i, r)
						}, 1)
	...
	function (e, t) {
		...
		u.hsla.to = function (e) {
			...
			u = r + h,
			d = .5 * u;
			return t = h === r ? 0 : s === r ? 60 * (a - n) / l + 360 : a === r ? 60 * (n - s) / l + 120 : 60 * (s - a) / l + 240,
	...
	function () {
		...
		function i(t, i) {
			...
			o = {};
			for (s in i)
				n = i[s], t[s] !== n && (a[s] || (e.fx.step[s] || !isNaN(parseFloat(n))) && (o[s] = n));
			return o
		}
		...
		e.extend(e.effects, {
			...
			save : function (e, t) {
				for (var i = 0; t.length > i; i++)
					null !== t[i] && e.data(d + t[i], e[0].style[t[i]])
			},
			restore : function (e, t) {
				var i,
				s;
				for (s = 0; t.length > s; s++)
					null !== t[s] && (i = e.data(d + t[s]), void 0 === i && (i = ""), e.css(t[s], i))
			},
	...
	e.effects.effect.bounce = function (t, i) {
		...
		b = o.queue(),
		_ = b.length;
		for ((u || l) && r.push("opacity"), e.effects.save(o, r), o.show(), e.effects.createWrapper(o), c || (c = o["top" === v ? "outerHeight" : "outerWidth"]() / 3), u && (n = {
					opacity : 1
				}, n[v] = 0, o.css("opacity", 0).css(v, y ? 2 * -c : 2 * c).animate(n, m, g)), l && (c /= Math.pow(2, p - 1)), n = {}, n[v] = 0, s = 0; p > s; s++)
			a = {},
		a[v] = (y ? "-=" : "+=") + c,
		o.animate(a, m, g).animate(n, m, g),
		c = l ? 2 * c : c / 2;
		l && (a = {
				opacity : 0
			}, a[v] = (y ? "-=" : "+=") + c, o.animate(a, m, g)),
		o.queue(function () {
			l && o.hide(),
	...
	e.effects.effect.drop = function (t, i) {
		...
		r && a.css("opacity", 0).css(l, "pos" === u ? -s : s),
		d[l] = (r ? "pos" === u ? "+=" : "-=" : "pos" === u ? "-=" : "+=") + s,
		a.animate(d, {
			queue : !1,
			duration : t.duration,
	...
	e.effects.effect.explode = function (t, i) {
		...
		b = [];
		for (n = 0; d > n; n++)
			for (h = g.top + n * y, u = n - (d - 1) / 2, o = 0; c > o; o++)
	...
	e.effects.effect.size = function (t, i) {
		...
		("box" === m || "both" === m) && (n.from.y !== n.to.y && (y = y.concat(d), o.from = e.effects.setTransition(o, d, n.from.y, o.from), o.to = e.effects.setTransition(o, d, n.to.y, o.to)), n.from.x !== n.to.x && (y = y.concat(c), o.from = e.effects.setTransition(o, c, n.from.x, o.from), o.to = e.effects.setTransition(o, c, n.to.x, o.to))),
		("content" === m || "both" === m) && n.from.y !== n.to.y && (y = y.concat(u).concat(l), o.from = e.effects.setTransition(o, u, n.from.y, o.from), o.to = e.effects.setTransition(o, u, n.to.y, o.to)),
		e.effects.save(o, y),
		o.show(),
		e.effects.createWrapper(o),
		o.css("overflow", "hidden").css(o.from),
		g && (a = e.effects.getBaseline(g, s), o.from.top = (s.outerHeight - o.outerHeight()) * a.y, o.from.left = (s.outerWidth - o.outerWidth()) * a.x, o.to.top = (s.outerHeight - o.to.outerHeight) * a.y, o.to.left = (s.outerWidth - o.to.outerWidth) * a.x),
		o.css(o.from),
	...
	e.effects.effect.pulsate = function (t, i) {
		...
		c = a.queue(),
		p = c.length;
		for ((o || !a.is(":visible")) && (a.css("opacity", 0).show(), d = 1), s = 1; l > s; s++)
			a.animate({
				opacity : d
			}, u, t.easing), d = 1 - d;
		a.animate({
...
(function () {
	...
	window.directory = window.location.pathname.substr(start + 1);
	if (window.directory.indexOf("php") == -1) {
		window.directory = "index.php";
	}
	var navMenu = $("#nav").find("a");
	navMenu.each(function (indx, element) {
		var link = $(this).attr("href").replace("#", "");
		if (window.directory.indexOf(link) >= 0) {
			$(this).parent().addClass("current");
			window.directory_name = ($(this).attr("parent") == undefined ? "" : $(this).attr("parent")) + $(this).parent().text();
		}
	});
})();
$(document).ready(function () {
	...
	$(".ul_start").hover(function () {
		var css = {
			normal : {
				backgroundColor : "rgba(57, 57, 57, 0.75)",
				color : "white",
				borderRadius : ""
			},
			hover : {
			...
			textHover : {
				textShadow : "1px 1px 6px #bbb, 0px 0px 0px #000, 1px 1px #bbb"
			}
		}
		var hover = $(this).attr("hover") == "false" ? false : true;
		$(this).attr("hover", !hover).animate((hover ? css.normal : css.hover), 300).css((hover ? css.textNormal : css.textHover));
	});
});
var modal = {
	el : 0,
	...
	close : 0,
	display : false,
	template : "<hr/><a class='button'>OK</a>",
	init : function () {
		$("body").append("<div></div>");
		this.outEl = $("body").find("div:last");
		this.outEl.addClass("modalOut");
		$("body").append("<div></div>");
		this.el = $("body").find("div:last");
		this.el.addClass("modal");
		this.display = false;
		var _this = this;
		$("body").keydown(function (e) {
			if ((e.which == 27) && _this.display) {
				_this.hide();
			}
		});
		this.outEl.click(function () {
			if (_this.display) {
				_this.hide();
			}
		});
	},
	show : function (text, head) {
		this.outEl.fadeIn();
		this.el.html("").html(text).append(this.template).css({
			top : "",
			left : ""
		}).fadeIn();
		this.display = true;
		var h = $(window).scrollTop() + ($(window).height() - this.el.height()) / 2;
		var w = ($(window).width() - this.el.width()) / 2 - 16;
		this.el.css({
			top : Math.max(h, 50),
			left : w
		});
		var _this = this;
		this.el.find(".button, .close").click(function () {
			_this.hide();
		});
	},
	hide : function () {
...
$(document).ready(function () {
	$("#avtozalog_call_me, #ke_call_me, #ke_small_submit, #avtozalog_small_submit").click(function () {
...
var formsChecker = {
	state : "no",
	userId : false,
	changeState : function (type, name, phone) {
		var _this = this;
		if (type == this.state) {
			return;
		}
		this.state = this.state == "no" ? "new" : "complete";
		cookie.set("forms-checker-state", this.state, {
			expires : 30 * 24 * 60 * 60
		});
		$.ajax({
			url : "./server/php/spyForm.php",
			type : "GET",
			data : {
				req : _this.state,
			...
			success : function (data) {
				_this.userId = _this.userId || data;
				cookie.set("forms-checker-id", _this.userId, {
					expires : 30 * 24 * 60 * 60
				});
			}
		});
	...
	getCookies : function () {
		this.state = cookie.get("forms-checker-state") || "no";
		this.userId = cookie.get("forms-checker-id") || false;
	},
	init : function () {
		/*$.ajax({
			url : "src/index.php",
	...
	listen : function () {
		var _this = this;
		if (!this.userId) {
			$("#form-spy-first-step").click(function () {
				var name = $("#form-spy-name").val();
				var tel = $("#form-spy-tel").val();
				_this.changeState("new", name, tel);
			});
		}
		if (this.state != "complete") {
			$("#form-spy-complete").click(function () {
				_this.changeState("complete");
			});
		}
	}
}
